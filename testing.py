...
class Test_data_processing(unittest.TestCase):     
    ...
    def test_import_data(self):        
        dp.import_data(trainingsdaten,'testtabelle',test_database)
    ...
    def test_validate_testdata(self):
        ideale_passungen = dp.get_fits_with_least_square_method(trainingsdaten,
                                                       daten_ideale_funktionen)        
...
if os.path.exists(f'{test_database}.db'):
